        ...
        <div class="card">
            <div class="d-flex align-items-end row">
                ...
                <div class="col-4 pt-3 ps-0">
                    <img src="../../demo/assets/img/illustrations/prize-light.png" width="90" height="140" class="rounded-start" alt="View Sales">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6 col-md-3 col-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                                <img src="../../demo/assets/img/icons/unicons/briefcase.png" alt="Credit Card" class="rounded">
                            </div>
                            <div class="dropdown">
            ...
            <div class="col-12 col-sm-6 col-md-3 col-lg-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                                <img src="../../demo/assets/img/icons/unicons/cc-warning.png" alt="Credit Card" class="rounded">
                            </div>
                            <div class="dropdown">
                ...
                <table class="table text-nowrap">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="../../demo/assets/img/icons/products/magic-mouse.png" alt="Apple" height="32" width="32" class="me-2">
                                    <div class="d-flex flex-column">
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="../../demo/assets/img/icons/products/imac-pro.png" alt="Apple" height="32" width="32" class="me-2">
                                    <div class="d-flex flex-column">
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="../../demo/assets/img/icons/products/note10.png" alt="Samsung" height="32" width="32" class="me-2">
                                    <div class="d-flex flex-column">
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="../../demo/assets/img/icons/products/iphone.png" alt="Apple" height="32" width="32" class="me-2">
                                    <div class="d-flex flex-column">
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="../../demo/assets/img/icons/products/mi-tv.png" alt="Xiaomi" height="32" width="32" class="me-2">
                                    <div class="d-flex flex-column">
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="../../demo/assets/img/icons/products/logitech-mx.png" alt="Logitech" height="32" width="32" class="me-2">
                                    <div class="d-flex flex-column">
